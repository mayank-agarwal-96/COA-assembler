...
int main() {
    ...
    while (n < m) {
      //  printf("%s\n", machine_code123[n]);
        ...
        //    char *fun = getOpcodeName(machine_code);        //searches for current opcode in the trie and gives the corresponding opcode
        if(!strcmp(machine_code123[n] , "11111111111111111111111111111111")){
            n++;
            continue;
        }
      ...
      //  printf("%s\n", form);
        ...
        if (strcmp(fun, "ARRD") == 0) {
            ...
            {
                a1 = (int *) malloc(registers[num3] * sizeof (int)); //A1 declared
            }
            if (strcmp(str2, "10001") == 0) // A2 register
            {
                a2 = (int *) malloc(registers[num3] * sizeof (int)); //A2 declared
            }
            if (strcmp(str2, "10010") == 0) // A3 register
            {
                a3 = (int *) malloc(registers[num3]* sizeof (int)); //A3 declared
            }
            if (strcmp(str2, "10011") == 0) // A4 register
            {
                a4 = (int *) malloc(registers[num3]* sizeof (int)); //A4 declared
            }
            printf("size -> %d\n",registers[num3] );
        }
        if (strcmp(fun, "ARRI") == 0) {
            ...
            {
                a1[registers[num2]] = registers[num3];
            }
            if (strcmp(str1, "10001") == 0) // A2 register
            {
                a2[registers[num2]] = registers[num3];
            }
            if (strcmp(str1, "10010") == 0) // A3 register
            {
                a3[registers[num2]] = registers[num3];
            }
            if (strcmp(str1, "10011") == 0) // A4 register
            {
                a4[registers[num2]] = registers[num3];
            }
            printf("Value ->%d\n", a1[registers[num2]]);
        }
        if (strcmp(fun, "ARRC") == 0) {
            ...
            if (strcmp(str1, "10000") == 0) // A1 register
            {
                if (a1[registers[num2]] == registers[num3])
                    fstatus = 0;
                else if (a1[registers[num2]] > registers[num3])
            ...
            if (strcmp(str1, "10001") == 0) // A2 register
            {
                if (a2[registers[num2]] == registers[num3])
                    fstatus = 0;
                else if (a2[registers[num2]] > registers[num3])
                    fstatus = 1; // if left operand(Array) is greater than right operand (Register)
                else
                    fstatus = -1;
            }
            if (strcmp(str1, "10010") == 0) // A3 register
            {
                if (a3[registers[num2]] == registers[num3])
                    fstatus = 0;
                else if (a3[registers[num2]] > registers[num3])
                    fstatus = 1; // if left operand(Array) is greater than right operand (Register)
                else
                    fstatus = -1;
